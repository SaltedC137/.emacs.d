...
(require 'acs/custom (file-name-concat user-emacs-directory "etc/acs-custom.el"))

(when (or (eq system-type 'windows-nt)
      (native-comp-available-p))
(startup-redirect-eln-cache (acs/c:appdata/ #:acs--startup-redirect-eln-cache /)))

(require 'acs-package)  ; (find-file-other-window "./acs-package.el")
